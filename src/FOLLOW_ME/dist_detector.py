...
class Template(object):
	def __init__(self, args):
		...
		self.args = args
		self.publisher = rospy.Publisher("/duckiebot/bot_detector",Image, queue_size=10)
	...
	def procesar_img(self, msg):
		...
		lower_limit=np.array([85,100,100])
...
def main():
	rospy.init_node('dis_detector') #creacion y registro del nodo!
